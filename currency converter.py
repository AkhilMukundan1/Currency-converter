...
headlabel = tk.Label(Tops,font=('lato black', 19,'bold'), text = '      Real time   :    Currency Converter  ', bg= '#663300',fg='white') 
...
CurrenyCode_list = ["INR", "USD", "CAD", "CNY", "DKK", "EUR","AUD","GBP","AFN","BHD","BRL","BGN","EGP","GEL","GRD","HKD","IDR","MYR","SGD"]
